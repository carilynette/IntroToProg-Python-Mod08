...
class Employee(Person):
    ...
    def review_date(self, value):
        try:
            if isinstance(value, date):
                ...
                raise ValueError("The review date should be a date or a string YYYY-MM-DD.")
        except ValueError:
    ...
    def __str__(self):
        return f"{self.first_name},{self.last_name},{self.review_date.isoformat()},{self.review_rating}"
